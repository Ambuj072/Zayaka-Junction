...
const RestaurentCart = ({ image, title, rating, location }) => {
  return (
    <div className="card">
    ...
    return (
        <div className="body">
            ...
            <div className="res-container">
                ...
                />
                  <RestaurentCart
                    image="https://b.zmtcdn.com/data/pictures/4/209654/7bf8c7d5947e6f8586148a5a426b0168.jpg"
                    title="Rasoi Ghar "
                    rating="4.9"
                    location="Beta 2,Greater Noida, India"
                />
                  <RestaurentCart
                    image="https://b.zmtcdn.com/data/pictures/4/21582384/ff83746dc1ace604e0b09db310e5a39f_featured_v2.jpg"
                    title="Khaati Peeti Rasoi "
                    rating="4.7"
                    location="Gamma 2,Greater Noida, India"
                />
                  <RestaurentCart
                    image="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_366/9fc1e9ebc45d764068261af568e3be14"
                    title="Desi Thali Junction "
                    rating="4.6"
                    location="Zeta 1,Greater Noida, India"
                />
                  <RestaurentCart
                    image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSaVXawkm-7E23rYbf4zwzdDjxhi1AId2W_Zg&s"
